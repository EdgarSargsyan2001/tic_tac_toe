 at the beginning we create an array of 9 lengths, we pass it to "Square" and it returns 9 divs on which we click on "handelClick" - the function which in turn puts "X" or "O".
